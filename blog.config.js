...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '李谨西', // 您的昵称 例如 tangly1024 
  BIO: process.env.NEXT_PUBLIC_BIO || 'the Empire of the Foolish Emperor', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'empire.foolishemperor.cn', // 网站地址  
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '理智,谨慎,希望 ', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '2763155815@qq.com', // 邮箱地址 例如mail@tangly1024.com  
